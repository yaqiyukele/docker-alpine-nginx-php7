...
$result['pageC2'] = implode("@#$",$pageC2_res);
...
$pageC7_str = implode("@#$",$pageC7_res);
$result['pageC7'] = $arr['pageST7']."@#$%".$pageC7_str;

$pageC8_result = preg_replace("/[\s]+/is"," ",$arr['pageC8']);
$pageC8_res = explode(' ',$pageC8_result);
$result['pageC8'] = implode("@#$",$pageC8_res);
...
$WHERE8 = "relevance_id='".$infoid."' AND page=8";
...
$sql8 = "UPDATE content SET title='".$arr['pageT8']."' , content='".$result['pageC8']."' WHERE ".$WHERE8;
// echo $sql0."<br>";
// echo $sql1."<br>";
// echo $sql2."<br>";
// echo $sql3."<br>";
