...
wxdata = {
    wx_account :[],
    wx_share : [],
    wx_appid:"wx80c487097b512789",
    wx_appsec:"422d3a86338493d2f7b0e56507e5ac19",
    access_token : "", // 凭证
    token_expires_in : "" , // 凭证过期时间 单位：s
    jsapi_ticket : "", // 凭证
    ticket_expires_in : "" , // 凭证过期时间 单位：s
    url : "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx80c487097b512789&secret=422d3a86338493d2f7b0e56507e5ac19",
...
//
//wxdata.wx_account[0] = wxdata.wx_appid;  // appid
...
//
//wxdata.wx_share[0] = "http://maida.houxm.com/mindata-tools/images/page.jpg";  // share_img 分享缩略图图片
//wxdata.wx_share[1] = window.location.href;// share_link  分享页面的url地址，如果地址无效，则分享失败
//wxdata.wx_share[2] = "2017年9月第4周-麦达数字技术部工作周报";// share_desc
//wxdata.wx_share[3] = "麦达数字技术部工作周报";// share_title
//   --------   5 结束 ----------
