<?php
require QY_ROOT."wechat-php-sdk/include.php";
...
function load_wechat($type = '') {
    ...
    if (!isset($wechat[$index])) {
        ...
        $options = array(
            'token'           => '', // 填写你设定的key
            'appid'           => 'wxe1fbca6a01635e1d', // 填写高级调用功能的app id, 请在微信开发模式后台查询
            'appsecret'       => '42220ab315a485e1cdf52697805f3649', // 填写高级调用功能的密钥
...
function cnzz()
{
	print "<div style=display:none>\n<script language=\"javascript\" type=\"text/javascript\" src=\"http://js.users.51.la/18997354.js\"></script>\n</div>";
}
